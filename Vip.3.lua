...
CombatMenuButton.Position = UDim2.new(0, 0, 0, 265)
CombatMenuButton.BackgroundColor3 = Color3.fromRGB(120, 15, 15)
CombatMenuButton.Text = "Combat Mấy Kid"
CombatMenuButton.TextColor3 = Color3.fromRGB(255, 255, 255)
CombatMenuButton.Font = Enum.Font.SourceSansBold
CombatMenuButton.TextSize = 14
